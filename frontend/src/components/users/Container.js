// aqui va un container que contiene un mensaje para el usuario: si está conectado o no, un botón de desconexión(signOut) y las dos rutas(signIn and signOut)
